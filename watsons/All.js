    ...
    if (path.length>3 && 'p' == path[2] && ("http://www.watsons.com.ph" == window.location.origin || "https://www.watsons.com.ph" == window.location.origin))
    {
    ...
    if (path.length>3 && 'p' == path[2] && ("http://www.watsons.com.sg" == window.location.origin || "https://www.watsons.com.sg" == window.location.origin))
    {
        ...
        if (jQuery("#funa") || jQuery("#funa").length <= 0) {
            ...
            p_html += 'var data = {};';
            p_html += 'data.url = window.location.href;';
            p_html += 'var volume = jQuery(".Volume_Options .Options_list .active").text().trim();';
            p_html += 'if (volume) {volume = volume.split("|")[1].trim();};';
            p_html += 'data.weight = "";';
            p_html += 'if (volume){data.weight = volume.match(/[0-9.]+/g)[0];};';
            p_html += 'data.unit = "";';
